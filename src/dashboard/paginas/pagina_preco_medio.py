...
def colunas() -> Row:
    ...
    dados_hoje = gerenciador.pagina_preco_medio_dados_hoje()

    dados_escolhido = gerenciador.pagina_preco_medio_dados_ultima_semana()

    dados_historico = gerenciador.pagina_preco_medio_dados_historico()
...
def preco_medio_atualiza_dados_periodo_escolhido(titulo, data_inicio, data_fim):
    if titulo != "":
        raise PreventUpdate
